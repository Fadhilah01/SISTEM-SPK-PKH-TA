...
- **calon_bp** (`routes/calon.py`): Mengatur manajemen CRUD data calon penerima, bulk import/export, pemicuan klasifikasi ulang SVM, serta modul perangkingan Confidence Score.
